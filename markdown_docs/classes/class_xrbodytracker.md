...
| [JointFlags]        | get_joint_flags(joint: Joint)                                                                           |
|-------------------------------------------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| [Transform3D](class_transform3d.md#class-transform3d) | get_joint_transform(joint: Joint)                                                                   |
|                                                       | set_joint_flags(joint: Joint, flags: [JointFlags])                    |
|                                                       | set_joint_transform(joint: Joint, transform: [Transform3D](class_transform3d.md#class-transform3d)) |
...
-  **set_body_flags**(value: [BodyFlags])
- [BodyFlags] **get_body_flags**()

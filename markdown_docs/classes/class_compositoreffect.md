...
| [bool](class_bool.md#class-bool)                                | access_resolved_color     |
|-----------------------------------------------------------------|-------------------------------------------------------------------------------------|
| [bool](class_bool.md#class-bool)                                | access_resolved_depth     |
| EffectCallbackType | effect_callback_type       |
| [bool](class_bool.md#class-bool)                                | enabled                                 |
| [bool](class_bool.md#class-bool)                                | needs_motion_vectors       |
| [bool](class_bool.md#class-bool)                                | needs_normal_roughness   |
| [bool](class_bool.md#class-bool)                                | needs_separate_specular |

## Methods

|    | \_render_callback(effect_callback_type: [int](class_int.md#class-int), render_data: [RenderData](class_renderdata.md#class-renderdata))    |
|----|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
...
-  **set_effect_callback_type**(value: EffectCallbackType)

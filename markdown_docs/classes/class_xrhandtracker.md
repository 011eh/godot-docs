...
| [Vector3](class_vector3.md#class-vector3)              | get_hand_joint_angular_velocity(joint: HandJoint)                                                              |
|--------------------------------------------------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| [HandJointFlags] | get_hand_joint_flags(joint: HandJoint)                                                                                    |
| [Vector3](class_vector3.md#class-vector3)              | get_hand_joint_linear_velocity(joint: HandJoint)                                                                |
| [float](class_float.md#class-float)                    | get_hand_joint_radius(joint: HandJoint)                                                                                  |
| [Transform3D](class_transform3d.md#class-transform3d)  | get_hand_joint_transform(joint: HandJoint)                                                                            |
|                                                        | set_hand_joint_angular_velocity(joint: HandJoint, angular_velocity: [Vector3](class_vector3.md#class-vector3)) |
|                                                        | set_hand_joint_flags(joint: HandJoint, flags: [HandJointFlags])                     |
|                                                        | set_hand_joint_linear_velocity(joint: HandJoint, linear_velocity: [Vector3](class_vector3.md#class-vector3))    |
|                                                        | set_hand_joint_radius(joint: HandJoint, radius: [float](class_float.md#class-float))                                     |
|                                                        | set_hand_joint_transform(joint: HandJoint, transform: [Transform3D](class_transform3d.md#class-transform3d))          |
...
-  **set_hand_tracking_source**(value: HandTrackingSource)

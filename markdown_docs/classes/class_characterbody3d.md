...
**CharacterBody3D** is a specialized class for physics bodies that are meant to be user-controlled. They are not affected by physics at all, but they affect other physics bodies in their path. They are mainly used to provide high-level API to move objects with wall and slope detection (move_and_slide() method) in addition to the general collision detection provided by [PhysicsBody3D.move_and_collide()](class_physicsbody3d.md#class-physicsbody3d-method-move-and-collide). This makes it useful for highly configurable physics bodies that must move in specific ways and collide with the world, as is often the case with user-controlled characters.
...
| [bool](class_bool.md#class-bool)                         | floor_block_on_wall     | `true`             |
|----------------------------------------------------------|--------------------------------------------------------------------------------|--------------------|
| [bool](class_bool.md#class-bool)                         | floor_constant_speed   | `false`            |
| [float](class_float.md#class-float)                      | floor_max_angle             | `0.7853982`        |
| [float](class_float.md#class-float)                      | floor_snap_length         | `0.1`              |
| [bool](class_bool.md#class-bool)                         | floor_stop_on_slope     | `true`             |
| [int](class_int.md#class-int)                            | max_slides                       | `6`                |
| MotionMode           | motion_mode                     | `0`                |
| [int](class_int.md#class-int)                            | platform_floor_layers | `4294967295`       |
| PlatformOnLeave | platform_on_leave         | `0`                |
| [int](class_int.md#class-int)                            | platform_wall_layers   | `0`                |
| [float](class_float.md#class-float)                      | safe_margin                     | `0.001`            |
| [bool](class_bool.md#class-bool)                         | slide_on_ceiling           | `true`             |
| [Vector3](class_vector3.md#class-vector3)                | up_direction                   | `Vector3(0, 1, 0)` |
| [Vector3](class_vector3.md#class-vector3)                | velocity                           | `Vector3(0, 0, 0)` |
| [float](class_float.md#class-float)                      | wall_min_slide_angle   | `0.2617994`        |

## Methods

|                                                                                  | apply_floor_snap()                                                                         |
|----------------------------------------------------------------------------------|----------------------------------------------------------------------------------------------------------------------------------------------|
| [float](class_float.md#class-float)                                              | get_floor_angle(up_direction: [Vector3](class_vector3.md#class-vector3) = Vector3(0, 1, 0)) |
| [Vector3](class_vector3.md#class-vector3)                                        | get_floor_normal()                                                                         |
| [Vector3](class_vector3.md#class-vector3)                                        | get_last_motion()                                                                           |
| [KinematicCollision3D](class_kinematiccollision3d.md#class-kinematiccollision3d) | get_last_slide_collision()                                                         |
| [Vector3](class_vector3.md#class-vector3)                                        | get_platform_angular_velocity()                                               |
| [Vector3](class_vector3.md#class-vector3)                                        | get_platform_velocity()                                                               |
| [Vector3](class_vector3.md#class-vector3)                                        | get_position_delta()                                                                     |
| [Vector3](class_vector3.md#class-vector3)                                        | get_real_velocity()                                                                       |
| [KinematicCollision3D](class_kinematiccollision3d.md#class-kinematiccollision3d) | get_slide_collision(slide_idx: [int](class_int.md#class-int))                           |
| [int](class_int.md#class-int)                                                    | get_slide_collision_count()                                                       |
| [Vector3](class_vector3.md#class-vector3)                                        | get_wall_normal()                                                                           |
| [bool](class_bool.md#class-bool)                                                 | is_on_ceiling()                                                                               |
| [bool](class_bool.md#class-bool)                                                 | is_on_ceiling_only()                                                                     |
| [bool](class_bool.md#class-bool)                                                 | is_on_floor()                                                                                   |
| [bool](class_bool.md#class-bool)                                                 | is_on_floor_only()                                                                         |
| [bool](class_bool.md#class-bool)                                                 | is_on_wall()                                                                                     |
| [bool](class_bool.md#class-bool)                                                 | is_on_wall_only()                                                                           |
| [bool](class_bool.md#class-bool)                                                 | move_and_slide()                                                                             |
...
-  **set_motion_mode**(value: MotionMode)
...
-  **set_platform_on_leave**(value: PlatformOnLeave)
...
Vector pointing upwards, used to determine what is a wall and what is a floor (or a ceiling) when calling move_and_slide(). Defaults to [Vector3.UP](class_vector3.md#class-vector3-constant-up). As the vector will be normalized it can't be equal to [Vector3.ZERO](class_vector3.md#class-vector3-constant-zero), if you want all collisions to be reported as walls, consider using MOTION_MODE_FLOATING as motion_mode.
...
Returns the floor's collision angle at the last collision point according to `up_direction`, which is [Vector3.UP](class_vector3.md#class-vector3-constant-up) by default. This value is always positive and only valid after calling move_and_slide() and when is_on_floor() returns `true`.
...
Returns a [KinematicCollision3D](class_kinematiccollision3d.md#class-kinematiccollision3d) if a collision occurred. The returned value contains information about the latest collision that occurred during the last call to move_and_slide(). Returns `null` if no collision occurred. See also get_slide_collision().
...
Moves the body based on velocity. If the body collides with another, it will slide along the other body rather than stop immediately. If the other body is a **CharacterBody3D** or [RigidBody3D](class_rigidbody3d.md#class-rigidbody3d), it will also be affected by the motion of the other body. You can use this to make moving and rotating platforms, or to make nodes push other nodes.

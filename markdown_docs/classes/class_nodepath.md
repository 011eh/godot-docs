...
In some situations, it's possible to omit the leading `:` when pointing to an object's property. As an example, this is the case with [Object.set_indexed()](class_object.md#class-object-method-set-indexed) and [Tween.tween_property()](class_tween.md#class-tween-method-tween-property), as those methods call get_as_property_path() under the hood. However, it's generally recommended to keep the `:` prefix.
...
| NodePath   | NodePath(from: [String](class_string.md#class-string)) |

## Methods

| NodePath                        | get_as_property_path()                                                        |
|----------------------------------------------------|------------------------------------------------------------------------------------------------------------------------------|
| [StringName](class_stringname.md#class-stringname) | get_concatenated_names()                                                    |
| [StringName](class_stringname.md#class-stringname) | get_concatenated_subnames()                                              |
| [StringName](class_stringname.md#class-stringname) | get_name(idx: [int](class_int.md#class-int))                                              |
| [int](class_int.md#class-int)                      | get_name_count()                                                                    |
| [StringName](class_stringname.md#class-stringname) | get_subname(idx: [int](class_int.md#class-int))                                        |
| [int](class_int.md#class-int)                      | get_subname_count()                                                              |
| [int](class_int.md#class-int)                      | hash()                                                                                        |
| [bool](class_bool.md#class-bool)                   | is_absolute()                                                                          |
| [bool](class_bool.md#class-bool)                   | is_empty()                                                                                |
| NodePath                        | slice(begin: [int](class_int.md#class-int), end: [int](class_int.md#class-int) = 2147483647) |

## Operators

| [bool](class_bool.md#class-bool)   | operator !=(right: NodePath)   |
|------------------------------------|--------------------------------------------------------------------------------------------|
| [bool](class_bool.md#class-bool)   | operator ==(right: NodePath)    |
...
Constructs a **NodePath** from a [String](class_string.md#class-string). The created path is absolute if prefixed with a slash (see is_absolute()).

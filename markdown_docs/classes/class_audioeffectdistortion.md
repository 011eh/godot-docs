...
| [float](class_float.md#class-float)      | drive           | `0.0`     |
|------------------------------------------|----------------------------------------------------------------|-----------|
| [float](class_float.md#class-float)      | keep_hf_hz | `16000.0` |
| Mode | mode             | `0`       |
| [float](class_float.md#class-float)      | post_gain   | `0.0`     |
| [float](class_float.md#class-float)      | pre_gain     | `0.0`     |

...
| [float](class_float.md#class-float)                               | angular_velocity                   | `0.0`           |
| [bool](class_bool.md#class-bool)                                  | can_sleep                                 | `true`          |
| [Vector2](class_vector2.md#class-vector2)                         | center_of_mass                       | `Vector2(0, 0)` |
| CenterOfMassMode            | center_of_mass_mode             | `0`             |
| [Vector2](class_vector2.md#class-vector2)                         | constant_force                       | `Vector2(0, 0)` |
| [float](class_float.md#class-float)                               | constant_torque                     | `0.0`           |
...
| [float](class_float.md#class-float)                               | inertia                                     | `0.0`           |
| [float](class_float.md#class-float)                               | linear_damp                             | `0.0`           |
| DampMode                            | linear_damp_mode                   | `0`             |
| [Vector2](class_vector2.md#class-vector2)                         | linear_velocity                     | `Vector2(0, 0)` |
...
|                                                                             | \_integrate_forces(state: [PhysicsDirectBodyState2D](class_physicsdirectbodystate2d.md#class-physicsdirectbodystate2d))             |
|-----------------------------------------------------------------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
|                                                                             | add_constant_central_force(force: [Vector2](class_vector2.md#class-vector2))                                                      |
...
|                                                                             | apply_central_force(force: [Vector2](class_vector2.md#class-vector2))                                                                    |
|                                                                             | apply_central_impulse(impulse: [Vector2](class_vector2.md#class-vector2) = Vector2(0, 0))                                              |
...
|                                                                             | apply_torque_impulse(torque: [float](class_float.md#class-float))                                                                       |
| [Array](class_array.md#class-array)[[Node2D](class_node2d.md#class-node2d)] | get_colliding_bodies()                                                                                                                  |
| [int](class_int.md#class-int)                                               | get_contact_count()                                                                                                                        |
|                                                                             | set_axis_velocity(axis_velocity: [Vector2](class_vector2.md#class-vector2))                                                                |
...
Emitted when a collision with another [PhysicsBody2D](class_physicsbody2d.md#class-physicsbody2d) or [TileMap](class_tilemap.md#class-tilemap) occurs. Requires contact_monitor to be set to `true` and max_contacts_reported to be set high enough to detect all the collisions. [TileMap](class_tilemap.md#class-tilemap)s are detected if the [TileSet](class_tileset.md#class-tileset) has Collision [Shape2D](class_shape2d.md#class-shape2d)s.
...
Emitted when the collision with another [PhysicsBody2D](class_physicsbody2d.md#class-physicsbody2d) or [TileMap](class_tilemap.md#class-tilemap) ends. Requires contact_monitor to be set to `true` and max_contacts_reported to be set high enough to detect all the collisions. [TileMap](class_tilemap.md#class-tilemap)s are detected if the [TileSet](class_tileset.md#class-tileset) has Collision [Shape2D](class_shape2d.md#class-shape2d)s.
...
Emitted when one of this RigidBody2D's [Shape2D](class_shape2d.md#class-shape2d)s collides with another [PhysicsBody2D](class_physicsbody2d.md#class-physicsbody2d) or [TileMap](class_tilemap.md#class-tilemap)'s [Shape2D](class_shape2d.md#class-shape2d)s. Requires contact_monitor to be set to `true` and max_contacts_reported to be set high enough to detect all the collisions. [TileMap](class_tilemap.md#class-tilemap)s are detected if the [TileSet](class_tileset.md#class-tileset) has Collision [Shape2D](class_shape2d.md#class-shape2d)s.
...
Emitted when the collision between one of this RigidBody2D's [Shape2D](class_shape2d.md#class-shape2d)s and another [PhysicsBody2D](class_physicsbody2d.md#class-physicsbody2d) or [TileMap](class_tilemap.md#class-tilemap)'s [Shape2D](class_shape2d.md#class-shape2d)s ends. Requires contact_monitor to be set to `true` and max_contacts_reported to be set high enough to detect all the collisions. [TileMap](class_tilemap.md#class-tilemap)s are detected if the [TileSet](class_tileset.md#class-tileset) has Collision [Shape2D](class_shape2d.md#class-shape2d)s.
...
-  **set_continuous_collision_detection_mode**(value: CCDMode)
...
**Note:** inertia is required for this to work. To have inertia, an active [CollisionShape2D](class_collisionshape2d.md#class-collisionshape2d) must be a child of the node, or you can manually set inertia.

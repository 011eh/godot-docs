...
| [JavaObject](class_javaobject.md#class-javaobject)   | create_proxy(object: [Object](class_object.md#class-object), interfaces: [PackedStringArray](class_packedstringarray.md#class-packedstringarray))   |
|------------------------------------------------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| [JavaObject](class_javaobject.md#class-javaobject)   | create_sam_callback(sam_interface: [String](class_string.md#class-string), callable: [Callable](class_callable.md#class-callable))           |
| [JavaObject](class_javaobject.md#class-javaobject)   | get_exception()                                                                                                                                    |
| [JavaClass](class_javaclass.md#class-javaclass)      | wrap(name: [String](class_string.md#class-string))                                                                                                          |
...
Creates a [JavaObject](class_javaobject.md#class-javaobject) implementing the given Java interfaces using the given [Object](class_object.md#class-object) as the implementation.
...
Creates a [JavaObject](class_javaobject.md#class-javaobject) implementing the Java Single Abstract Method (SAM) interface using the Godot [Callable](class_callable.md#class-callable) as the implementation.

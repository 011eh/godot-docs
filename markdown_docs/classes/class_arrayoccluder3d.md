...
| [PackedInt32Array](class_packedint32array.md#class-packedint32array)       | indices   | `PackedInt32Array()`   |
|----------------------------------------------------------------------------|------------------------------------------------------|------------------------|
| [PackedVector3Array](class_packedvector3array.md#class-packedvector3array) | vertices | `PackedVector3Array()` |

## Methods

|    | set_arrays(vertices: [PackedVector3Array](class_packedvector3array.md#class-packedvector3array), indices: [PackedInt32Array](class_packedint32array.md#class-packedint32array))   |
|----|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|

...
|---------------------------------------------------------------------|-------------------------------------------------------------------------------------------------------------------------|
| [Error](class_@globalscope.md#enum-globalscope-error)               | start(type: HashType)                            |
| [Error](class_@globalscope.md#enum-globalscope-error)               | update(chunk: [PackedByteArray](class_packedbytearray.md#class-packedbytearray)) |

...
|---------------------------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------|
| PropertyTweener   | from(value: [Variant](class_variant.md#class-variant))                                                        |
| PropertyTweener   | from_current()                                                                                        |
| PropertyTweener   | set_custom_interpolator(interpolator_method: [Callable](class_callable.md#class-callable)) |
| PropertyTweener   | set_delay(delay: [float](class_float.md#class-float))                                                    |
| PropertyTweener   | set_ease(ease: [EaseType](class_tween.md#enum-tween-easetype))                                            |
| PropertyTweener   | set_trans(trans: [TransitionType](class_tween.md#enum-tween-transitiontype))                             |

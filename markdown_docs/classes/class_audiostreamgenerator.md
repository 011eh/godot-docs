...
| [float](class_float.md#class-float)                                                   | buffer_length   | `0.5`     |
|---------------------------------------------------------------------------------------|-----------------------------------------------------------------------|-----------|
| [float](class_float.md#class-float)                                                   | mix_rate             | `44100.0` |
...
**Note:** If you are using [AudioEffectCapture](class_audioeffectcapture.md#class-audioeffectcapture) as the source of your data, set mix_rate_mode to MIX_RATE_INPUT or MIX_RATE_OUTPUT to automatically match current [AudioServer](class_audioserver.md#class-audioserver) mixing rate.

---

AudioStreamGeneratorMixRate **mix_rate_mode** = `2`

-  **set_mix_rate_mode**(value: AudioStreamGeneratorMixRate)
- AudioStreamGeneratorMixRate **get_mix_rate_mode**()

Mixing rate mode. If set to MIX_RATE_CUSTOM, mix_rate is used, otherwise current [AudioServer](class_audioserver.md#class-audioserver) mixing rate is used.

...
| [Vector3](class_vector3.md#class-vector3)                          | motion                           | `Vector3(0, 0, 0)`                                |
| [Resource](class_resource.md#class-resource)                       | shape                             |                                                   |
| [RID](class_rid.md#class-rid)                                      | shape_rid                     | `RID()`                                           |
...
The [Shape3D](class_shape3d.md#class-shape3d) that will be used for collision/intersection queries. This stores the actual reference which avoids the shape to be released while being used for queries, so always prefer using this over shape_rid.
...
The queried shape's [RID](class_rid.md#class-rid) that will be used for collision/intersection queries. Use this over shape if you want to optimize for performance using the Servers API:

...
| Mode                                            | mode                                     | `0`                                          |
| [bool](class_bool.md#class-bool)                                           | path_continuous_u           |                                              |
| [float](class_float.md#class-float)                                        | path_interval                   |                                              |
| PathIntervalType                    | path_interval_type         |                                              |
| [bool](class_bool.md#class-bool)                                           | path_joined                       |                                              |
| [bool](class_bool.md#class-bool)                                           | path_local                         |                                              |
| [NodePath](class_nodepath.md#class-nodepath)                               | path_node                           |                                              |
| PathRotation                            | path_rotation                   |                                              |
| [bool](class_bool.md#class-bool)                                           | path_rotation_accurate |                                              |
| [float](class_float.md#class-float)                                        | path_simplify_angle       |                                              |
| [float](class_float.md#class-float)                                        | path_u_distance               |                                              |
| [PackedVector2Array](class_packedvector2array.md#class-packedvector2array) | polygon                               | `PackedVector2Array(0, 0, 0, 1, 1, 1, 1, 0)` |
| [bool](class_bool.md#class-bool)                                           | smooth_faces                     | `false`                                      |
| [float](class_float.md#class-float)                                        | spin_degrees                     |                                              |
| [int](class_int.md#class-int)                                              | spin_sides                         |                                              |
...
The polygon shape is extruded along the [Path3D](class_path3d.md#class-path3d) specified in path_node.
...
-  **set_path_interval_type**(value: PathIntervalType)
...
When mode is MODE_PATH, if `true` the [Transform3D](class_transform3d.md#class-transform3d) of the **CSGPolygon3D** is used as the starting point for the extrusions, not the [Transform3D](class_transform3d.md#class-transform3d) of the path_node.
...
When mode is MODE_PATH, the location of the [Path3D](class_path3d.md#class-path3d) object used to extrude the polygon.

---

PathRotation **path_rotation**

-  **set_path_rotation**(value: PathRotation)

...
| [Vector3](class_vector3.md#class-vector3)                          | from                               | `Vector3(0, 0, 0)` |
| [bool](class_bool.md#class-bool)                                   | hit_back_faces           | `true`             |
| [bool](class_bool.md#class-bool)                                   | hit_from_inside         | `false`            |
| [Vector3](class_vector3.md#class-vector3)                          | to                                   | `Vector3(0, 0, 0)` |

## Methods

| PhysicsRayQueryParameters3D   | create(from: [Vector3](class_vector3.md#class-vector3), to: [Vector3](class_vector3.md#class-vector3), collision_mask: [int](class_int.md#class-int) = 4294967295, exclude: [Array](class_array.md#class-array)[[RID](class_rid.md#class-rid)] = [])    |
|---------------------------------------------------------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|

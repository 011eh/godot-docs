...
|----------------------------------------------------------------------------|---------------------------------------------------------------------------------------------|------------------------|
| [int](class_int.md#class-int)                                              | buffer_view                                     | `-1`                   |
| [int](class_int.md#class-int)                                              | byte_offset                                     | `0`                    |
| GLTFComponentType                  | component_type                               | `0`                    |
| [int](class_int.md#class-int)                                              | count                                                 | `0`                    |
| [PackedFloat64Array](class_packedfloat64array.md#class-packedfloat64array) | max                                                     | `PackedFloat64Array()` |
| [PackedFloat64Array](class_packedfloat64array.md#class-packedfloat64array) | min                                                     | `PackedFloat64Array()` |
| [bool](class_bool.md#class-bool)                                           | normalized                                       | `false`                |
| [int](class_int.md#class-int)                                              | sparse_count                                   | `0`                    |
| [int](class_int.md#class-int)                                              | sparse_indices_buffer_view       | `0`                    |
| [int](class_int.md#class-int)                                              | sparse_indices_byte_offset       | `0`                    |
| GLTFComponentType                  | sparse_indices_component_type | `0`                    |
| [int](class_int.md#class-int)                                              | sparse_values_buffer_view         | `0`                    |
| [int](class_int.md#class-int)                                              | sparse_values_byte_offset         | `0`                    |
| [int](class_int.md#class-int)                                              | type                                                   |                        |

## Methods

| GLTFAccessor                | from_dictionary(dictionary: [Dictionary](class_dictionary.md#class-dictionary))    |
|----------------------------------------------------|----------------------------------------------------------------------------------------------------------------------------------|
...
-  **set_accessor_type**(value: GLTFAccessorType)
...
-  **set_component_type**(value: GLTFComponentType)
...
-  **set_sparse_indices_component_type**(value: GLTFComponentType)

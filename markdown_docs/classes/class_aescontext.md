...
|                                                                   | finish()                                                                                                                                                                                                     |
|-------------------------------------------------------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| [PackedByteArray](class_packedbytearray.md#class-packedbytearray) | get_iv_state()                                                                                                                                                                                         |
| [Error](class_@globalscope.md#enum-globalscope-error)             | start(mode: Mode, key: [PackedByteArray](class_packedbytearray.md#class-packedbytearray), iv: [PackedByteArray](class_packedbytearray.md#class-packedbytearray) = PackedByteArray()) |
| [PackedByteArray](class_packedbytearray.md#class-packedbytearray) | update(src: [PackedByteArray](class_packedbytearray.md#class-packedbytearray))                                                                                                                               |
...
Run the desired operation for this AES context. Will return a [PackedByteArray](class_packedbytearray.md#class-packedbytearray) containing the result of encrypting (or decrypting) the given `src`. See start() for mode of operation.

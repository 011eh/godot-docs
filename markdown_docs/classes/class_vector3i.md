...
| Vector3i   | Vector3i(from: [Vector3](class_vector3.md#class-vector3))                                                      |
| Vector3i   | Vector3i(x: [int](class_int.md#class-int), y: [int](class_int.md#class-int), z: [int](class_int.md#class-int)) |

## Methods

| Vector3i         | abs()                                                                             |
|-------------------------------------|-----------------------------------------------------------------------------------------------------------------|
| Vector3i         | clamp(min: Vector3i, max: Vector3i)       |
| Vector3i         | clampi(min: [int](class_int.md#class-int), max: [int](class_int.md#class-int)) |
| [int](class_int.md#class-int)       | distance_squared_to(to: Vector3i)              |
| [float](class_float.md#class-float) | distance_to(to: Vector3i)                              |
| [float](class_float.md#class-float) | length()                                                                       |
| [int](class_int.md#class-int)       | length_squared()                                                       |
| Vector3i         | max(with: Vector3i)                                            |
| [int](class_int.md#class-int)       | max_axis_index()                                                       |
| Vector3i         | maxi(with: [int](class_int.md#class-int))                                        |
| Vector3i         | min(with: Vector3i)                                            |
| [int](class_int.md#class-int)       | min_axis_index()                                                       |
| Vector3i         | mini(with: [int](class_int.md#class-int))                                        |
| Vector3i         | sign()                                                                           |
| Vector3i         | snapped(step: Vector3i)                                    |
| Vector3i         | snappedi(step: [int](class_int.md#class-int))                                |

## Operators

| [bool](class_bool.md#class-bool)          | operator !=(right: Vector3i)      |
|-------------------------------------------|-----------------------------------------------------------------------------------------------|
| Vector3i               | operator %(right: Vector3i)       |
| Vector3i               | operator %(right: [int](class_int.md#class-int))          |
| Vector3i               | operator \*(right: Vector3i)      |
| [Vector3](class_vector3.md#class-vector3) | operator \*(right: [float](class_float.md#class-float)) |
| Vector3i               | operator \*(right: [int](class_int.md#class-int))         |
| Vector3i               | operator +(right: Vector3i)       |
| Vector3i               | operator -(right: Vector3i)       |
| Vector3i               | operator /(right: Vector3i)       |

...
|----------------------------------------------------|----------------------------------------------------------------------------------------------------------------------|----------|
| [int](class_int.md#class-int)                      | antialiasing                                             | `1`      |
...
| [int](class_int.md#class-int)                      | hinting                                                       | `3`      |
| [bool](class_bool.md#class-bool)                   | keep_rounding_remainders                     | `true`   |
| [Dictionary](class_dictionary.md#class-dictionary) | language_support                                     | `{}`     |
| [bool](class_bool.md#class-bool)                   | modulate_color_glyphs                           | `false`  |
| [int](class_int.md#class-int)                      | msdf_pixel_range                                     | `8`      |
...
| [Array](class_array.md#class-array)                | preload                                                       | `[]`     |
| [Dictionary](class_dictionary.md#class-dictionary) | script_support                                         | `{}`     |
| [int](class_int.md#class-int)                      | subpixel_positioning                             | `4`      |

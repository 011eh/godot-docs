...
| [int](class_int.md#class-int)       | radial_steps     | `8`      |
| [float](class_float.md#class-float) | radius                 | `0.5`    |
| [float](class_float.md#class-float) | section_length | `0.2`    |
| [int](class_int.md#class-int)       | section_rings   | `3`      |
| [int](class_int.md#class-int)       | sections             | `5`      |
...
Determines the radius of the tube along its length. The radius of a particular section ring is obtained by multiplying the baseline radius by the value of this curve at the given distance. For values smaller than `0`, the faces will be inverted. Should be a unit [Curve](class_curve.md#class-curve).

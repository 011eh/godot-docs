...
| [bool](class_bool.md#class-bool)                            | alpha_blend                                         | `false`                |
|-------------------------------------------------------------|-----------------------------------------------------------------------------------------------------------|------------------------|
| [Vector2i](class_vector2i.md#class-vector2i)                | android_surface_size                       | `Vector2i(1024, 1024)` |
| [bool](class_bool.md#class-bool)                            | enable_hole_punch                             | `false`                |
| EyeVisibility | eye_visibility                                   | `0`                    |
| [SubViewport](class_subviewport.md#class-subviewport)       | layer_viewport                                   |                        |
| [bool](class_bool.md#class-bool)                            | protected_content                             | `false`                |
| [int](class_int.md#class-int)                               | sort_order                                           | `1`                    |
| Swizzle             | swapchain_state_alpha_swizzle     | `3`                    |
| Swizzle             | swapchain_state_blue_swizzle       | `2`                    |
| [Color](class_color.md#class-color)                         | swapchain_state_border_color       | `Color(0, 0, 0, 0)`    |
| Swizzle             | swapchain_state_green_swizzle     | `1`                    |
| Wrap                   | swapchain_state_horizontal_wrap | `0`                    |
| Filter               | swapchain_state_mag_filter           | `1`                    |
| [float](class_float.md#class-float)                         | swapchain_state_max_anisotropy   | `1.0`                  |
...
| [bool](class_bool.md#class-bool)                            | use_android_surface                         | `false`                |

## Methods

| [JavaObject](class_javaobject.md#class-javaobject)   | get_android_surface()                                                                                              |
|------------------------------------------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| [Vector2](class_vector2.md#class-vector2)            | intersects_ray(origin: [Vector3](class_vector3.md#class-vector3), direction: [Vector3](class_vector3.md#class-vector3)) |
| [bool](class_bool.md#class-bool)                     | is_natively_supported()                                                                                          |
...
-  **set_eye_visibility**(value: EyeVisibility)
...
-  **set_alpha_swizzle**(value: Swizzle)
...
-  **set_blue_swizzle**(value: Swizzle)
...
-  **set_green_swizzle**(value: Swizzle)
...
-  **set_horizontal_wrap**(value: Wrap)
...
-  **set_mipmap_mode**(value: MipmapMode)
...
Returns a [JavaObject](class_javaobject.md#class-javaobject) representing an `android.view.Surface` if use_android_surface is enabled and OpenXR has created the surface. Otherwise, this will return `null`.

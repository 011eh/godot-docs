...
| [bool](class_bool.md#class-bool)          | keep_compressed_buffer   | `false`                                                                                           |
|-------------------------------------------|------------------------------------------------------------------------------------------------|---------------------------------------------------------------------------------------------------|
...
| [Vector2](class_vector2.md#class-vector2) | size_override                     | `Vector2(0, 0)`                                                                                   |

## Methods

|                                                                      | create_from_image(image: [Image](class_image.md#class-image), compression_mode: CompressionMode, normal_map: [bool](class_bool.md#class-bool) = false, lossy_quality: [float](class_float.md#class-float) = 0.8)   |
|----------------------------------------------------------------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| CompressionMode | get_compression_mode()                                                                                                                                                                                                                                               |
| [bool](class_bool.md#class-bool)                                     | is_keeping_all_compressed_buffers()                                                                                                                                                                                                                     |
|                                                                      | set_basisu_compressor_params(uastc_level: [int](class_int.md#class-int), rdo_quality_loss: [float](class_float.md#class-float))                                                                                                                              |
|                                                                      | set_keep_all_compressed_buffers(keep: [bool](class_bool.md#class-bool))                                                                                                                                                                                   |

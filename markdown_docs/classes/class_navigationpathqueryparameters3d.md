...
| [Array](class_array.md#class-array)[[RID](class_rid.md#class-rid)]                 | excluded_regions                 | `[]`               |
|------------------------------------------------------------------------------------|------------------------------------------------------------------------------------------------------|--------------------|
| [Array](class_array.md#class-array)[[RID](class_rid.md#class-rid)]                 | included_regions                 | `[]`               |
| [RID](class_rid.md#class-rid)                                                      | map                                           | `RID()`            |
...
-  **set_metadata_flags**(value: [PathMetadataFlags])
- [PathMetadataFlags] **get_metadata_flags**()

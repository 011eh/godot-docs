...
- To compress the whole volume in the Master bus (although an [AudioEffectHardLimiter](class_audioeffecthardlimiter.md#class-audioeffecthardlimiter) is probably better).
...
| [float](class_float.md#class-float)                | attack_us   | `20.0`   |
|----------------------------------------------------|----------------------------------------------------------------|----------|
| [float](class_float.md#class-float)                | gain             | `0.0`    |
| [float](class_float.md#class-float)                | mix               | `1.0`    |
| [float](class_float.md#class-float)                | ratio           | `4.0`    |
| [float](class_float.md#class-float)                | release_ms | `250.0`  |
| [StringName](class_stringname.md#class-stringname) | sidechain   | `&""`    |
| [float](class_float.md#class-float)                | threshold   | `0.0`    |

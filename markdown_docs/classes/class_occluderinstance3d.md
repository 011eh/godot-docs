...
|----------------------------------------------------|-------------------------------------------------------------------------------------------------|----------------|
| [float](class_float.md#class-float)                | bake_simplification_distance | `0.1`          |
| [Occluder3D](class_occluder3d.md#class-occluder3d) | occluder                                         |                |
...
You can also draw your own 2D occluder polygon by adding a new [PolygonOccluder3D](class_polygonoccluder3d.md#class-polygonoccluder3d) resource to the occluder property in the Inspector.

...
![Movie Maker mode is disabled, click the "movie reel" icon to enable](img/creating_movies_enable_movie_maker_mode.webp)
...
![Movie Maker mode is enabled, click the "movie reel" icon again to disable](img/creating_movies_disable_movie_maker_mode.webp)
...
![Movie Maker project settings (with Advanced toggle enabled)](img/creating_movies_project_settings.webp)
...
![Inspector view after creating a ``movie_file`` metadata of type String](img/creating_movies_set_per_scene_metadata.webp)

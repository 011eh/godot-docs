...
![The AnimationPlayer node](img/animation_create_animationplayer.webp)

After you create an AnimationPlayer node, click on it to
open the Animation Panel at the bottom of the viewport.

![The animation panel position](img/animation_animation_panel.webp)

The animation panel consists of four parts:

![The animation panel](img/animation_animation_panel_overview.webp)
...
![Keyframes in Godot](img/animation_keyframes.webp)
...
![Two keyframes are all it takes to obtain a smooth motion](img/animation_illustration.webp)

The timeline defines how long the animation will take. You can insert keyframes
at various points, and change their timing.

![The timeline in the animation panel](img/animation_timeline.webp)
...
![Example of Normal animation tracks](img/animation_normal_track.webp)
...
![Our scene setup](img/animation_animation_player_tree.webp)
...
animation editor. From the list, select "New" (![Add Animation](img/animation_add.png)) to add a new
animation. Enter a name for the animation in the dialog box.

![Add a new animation](img/animation_create_new_animation.webp)
...
![Manage animations](img/animation_library.webp)

If there are multiple animation libraries and you try to add an animation, a dialog box will appear with options.

![Add a new animation with library option](img/animation_library_dialog.webp)
...
![Convenience buttons](img/animation_convenience_buttons.webp)
...
![The sprite track](img/animation_track.webp)
...
![Animation length](img/animation_set_length.webp)
...
![Animation loop](img/animation_loop.webp)
...
![Track settings](img/animation_track_settings.webp)
...
![Track mode](img/animation_track_rate.webp)
...
![Track interpolation](img/animation_track_interpolation.webp)
...
![Loop modes](img/animation_track_loop_modes.webp)
...
![Keyframes for other properties](img/animation_properties_keyframe.webp)
...
![Keyframe editor editing a key](img/animation_keyframe_editor_key.webp)

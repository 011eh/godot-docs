...
![image](img/animtree_badanimcondition.webp)![image](img/animtree_badanimcondition.gif)
...
![image](img/animtree_goodanimcondition.webp)![image](img/animtree_goodanimcondition.gif)
...
![image](img/animtree_goodanimexpression.webp)![image](img/animtree_goodanimexpression2.webp)![image](img/animtree_goodanimexpression.gif)
...
#### WARNING
Cyclic sync modes require that all blend points use [AnimationNodeAnimation](../../classes/class_animationnodeanimation.md#class-animationnodeanimation)
...
[AnimationNodeTimeSeek](../../classes/class_animationnodetimeseek.md#class-animationnodetimeseek) to the output will break synchronization.
In that case, use [AnimationNodeAnimation.use_custom_timeline](../../classes/class_animationnodeanimation.md#class-animationnodeanimation-property-use-custom-timeline)
...
![image](img/blending3.webp)![image](img/blending4.webp)

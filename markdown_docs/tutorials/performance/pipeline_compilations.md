...
![Flowchart showing the entire compilation process for a shader: VisualShader and Standard Material to Godot Shading Language to GLSL to Intermediate Format (SPIR-V) to Pipeline. Shader Compilation is the GLSL to Intermediate Format step. Pipeline Compilation is the Intermediate Format to Pipeline step.](img/pipeline_compilations_shader_compilation_diagram.webp)
...
![Screenshot of the Godot pipeline compilations monitor](img/pipeline_compilations_monitors.webp)
...
![Screenshot of an example of a hidden Node for an effect](img/pipeline_compilations_hidden_node.webp)
...
using the `--headless` [command line argument](../editor/command_line_tutorial.md#doc-command-line-tutorial),

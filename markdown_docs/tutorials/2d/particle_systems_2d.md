...
![Example of a particle system that uses a flipbook texture](img/particles_flipbook_result.webp)
...
![Particle flipbook texture example](img/particles_flipbook_example.webp)
...
![Creating a CanvasItemMaterial at the bottom of the particles node inspector](img/particles_flipbook_create_canvasitemmaterial.webp)
...
![Configuring the CanvasItemMaterial for the example flipbook texture](img/particles_flipbook_configure_canvasitemmaterial.webp)

...
![No 2D lights or shadows, scene is unshaded](img/2d_lights_and_shadows_disabled.webp)![2D lights enabled (without shadows)](img/2d_lights_and_shadows_enabled_no_shadows.webp)![2D lights and shadows enabled](img/2d_lights_and_shadows_enabled.webp)
...
![Neutral point light texture](img/2d_lights_and_shadows_neutral_point_light.webp)
...
![Hard shadows](img/2d_lights_and_shadows_hard_shadow.webp)![Soft shadows (PCF13, Filter Smooth 1.5)](img/2d_lights_and_shadows_soft_shadow.webp)![Soft shadows with streaking artifacts due to Filter Smooth being too high (PCF5, Filter Smooth 4)](img/2d_lights_and_shadows_soft_shadow_streaks.webp)
...
![Creating a CanvasTexture resource for a Sprite2D node](img/2d_lights_and_shadows_create_canvastexture.webp)

...
![Saving the built-in TileSet resource to an external resource file](img/using_tilemaps_save_tileset_to_resource.webp)
...
![Opening the TileMap panel at the bottom of the editor. The TileMapLayer node must be selected first.](img/using_tilemaps_open_tilemap_editor.webp)
...
![Selecting a layer to paint on in the TileMap editor](img/using_tilemaps_select_layer.webp)
...
![Selecting a tile in the TileMap editor by clicking it](img/using_tilemaps_select_single_tile_from_tileset.webp)
...
![Selecting multiple tiles in the TileMap editor by holding down the left mouse button](img/using_tilemaps_select_multiple_tiles_from_tileset.webp)

If you've created alternative tiles in your TileSet, you can select them for
painting on the right of the base tiles:

![Selecting an alternative tile in the TileMap editor](img/using_tilemaps_use_alternative_tile.webp)

Lastly, if you've created a *scenes collection* in the TileSet, you can place scene tiles in the TileMap:

![Placing a scene tile containing particles using the TileMap editor](img/using_tilemaps_placing_scene_tiles.webp)
...
![Creating a new pattern from a selection in the TileMap editor](img/using_tilemaps_create_pattern.webp)
...
![Placing an existing pattern using the TileMap editor](img/using_tilemaps_use_pattern.webp)
...
![Selecting Connect mode in the TileMap editor's Terrains tab](img/using_tilemaps_terrain_select_connect_mode.webp)![Selecting Path mode in the TileMap editor's Terrains tab](img/using_tilemaps_terrain_select_path_mode.webp)

Lastly, you can select specific tiles from the terrain to resolve conflicts in
certain situations:

![Painting with specific tiles in the TileMap editor's Terrains tab](img/using_tilemaps_terrain_paint_specific_tiles.webp)
...
![Missing tiles in the TileMap editor due to the TileSet reference being broken](img/using_tilemaps_missing_tiles.webp)

...
![Creating a new TileSet resource within the TileMapLayer node](img/using_tilesets_create_new_tileset.webp)
...
![Using the Eraser tool to remove unwanted tiles from the TileSet atlas](img/using_tilesets_eraser_tool.webp)
...
![Adjusting TileSet atlas properties in the dedicated inspector (part of the TileSet panel)](img/using_tilesets_properties.webp)
...
![Creating a scenes collection in the TileSet editor](img/using_tilesets_creating_scene_collection.webp)
...
![Creating a scene tile after selecting the scenes collection in the TileSet editor](img/using_tilesets_scene_collection_create_scene_tile.webp)

Select this scene slot in the right column, then use **Quick Load** (or
**Load**) to load the scene file containing the particles:

![Creating a scene slot, then loading a scene file into it in the TileSet editor](img/using_tilesets_adding_scene_tile.webp)
...
![Creating a physics layer in the TileSet resource inspector (within the TileMapLayer node)](img/using_tilesets_create_physics_layer.webp)

If you also need navigation support, now is a good time to create a navigation layer:

![Creating a navigation layer in the TileSet resource inspector (within the TileMapLayer node)](img/using_tilesets_create_navigation_layer.webp)

If you need support for light polygon occluders, now is a good time to create an occlusion layer:

![Creating an occlusion layer in the TileSet resource inspector (within the TileMapLayer node)](img/using_tilesets_create_occlusion_layer.webp)
...
![Using default rectangle collision shape by pressing :kbd:`F`](img/using_tilesets_using_default_rectangle_collision.webp)
...
![Creating a custom data layer in the TileSet resource inspector (within the TileMapLayer node)](img/using_tilesets_create_custom_data_layer.webp)![Example of configured custom data layers with game-specific properties](img/using_tilesets_custom_data_layers_example.webp)
...
![Editing custom data in the TileSet editor while in Select mode](img/using_tilesets_edit_custom_data.webp)

Tile property painting
can also be used for custom data:

![Assigning custom data in the TileSet editor using tile property painting](img/using_tilesets_paint_custom_data.webp)
...
![Creating a terrain set in the TileSet resource inspector (within the TileMapLayer node)](img/using_tilesets_create_terrain_set.webp)
...
![Configuring terrain on a single tile in the TileSet editor's Select mode](img/using_tilesets_configure_terrain_on_tile.webp)
...
![Configuring terrain peering bits on a single tile in the TileSet editor's Select mode](img/using_tilesets_configure_terrain_peering_bits.webp)

An example configuration for a full tilesheet may look as follows:

![Example full tilesheet for a sidescrolling game](img/using_tilesets_terrain_example_tilesheet.webp)![Example full tilesheet for a sidescrolling game with terrain peering bits visible](img/using_tilesets_terrain_example_tilesheet_configuration.webp)
...
![Painting tile properties using the TileSet editor](img/using_tilesets_paint_tile_properties.webp)
...
![Creating an alternative tile by right-clicking a base tile in the TileSet editor](img/using_tilesets_create_alternative_tile.webp)
...
![Configuring an alternative tile after clicking it in the TileSet editor](img/using_tilesets_configure_alternative_tile.webp)

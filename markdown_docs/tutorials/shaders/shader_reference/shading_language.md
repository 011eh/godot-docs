...
![Adding a global uniform in the Shader Globals tab of the Project Settings](img/shading_language_adding_global_uniforms.webp)
...
![Setting a per-instance uniform's value in the GeometryInstance3D section of the inspector](img/shading_language_per_instance_uniforms_inspector.webp)

...
[blit_rect()](../../classes/class_drawabletexture2d.md#class-drawabletexture2d-method-blit-rect).
...
[texture blit shader](../shaders/shader_reference/texture_blit_shader.md#doc-texture-blit-shader). Even when the user does
...
To do so, you can instantiate and pass in a new [BlitMaterial](../../classes/class_blitmaterial.md#class-blitmaterial)
in the script.
...
DrawableTextures also have a [blit_rect_multi()](../../classes/class_drawabletexture2d.md#class-drawabletexture2d-method-blit-rect-multi)
...
Next, you'll need to create a [TextureRect](../../classes/class_texturerect.md#class-texturerect) node, which is going to
...
modulate parameter. We will use this [`plain white circle texture`](img/circle.svg),
...
you could connect a [ColorPickerButton](../../classes/class_colorpickerbutton.md#class-colorpickerbutton) node to the script to store

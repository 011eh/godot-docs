...
[game embedding](../editor/game_embedding.md#doc-game-embedding) is configured to use the Stretch to Fit
scaling option:

![image](img/multiple_resolutions_game_embedding_size_dropdown.webp)
...
![Fractional scaling example (incorrect pixel art appearance)](img/multiple_resolutions_pixel_art_fractional_scaling.webp)

This pixel art is also displayed with the `viewport` stretch mode, but the
stretch scale mode is set to `integer` this time:

![Integer scaling example (correct pixel art appearance)](img/multiple_resolutions_pixel_art_integer_scaling.webp)
...
images in SVG format by changing their import type to [DPITexture](../../classes/class_dpitexture.md#class-dpitexture) in
...
#### NOTE
Control's [offset_transform_enabled](../../classes/class_control.md#class-control-property-offset-transform-enabled)
property is taken into account by scale-based oversampling, but only if
[offset_transform_visual_only](../../classes/class_control.md#class-control-property-offset-transform-visual-only) is *disabled*.
When [offset_transform_visual_only](../../classes/class_control.md#class-control-property-offset-transform-visual-only) is enabled,
...
For SVG images, you can also change their import type to [DPITexture](../../classes/class_dpitexture.md#class-dpitexture) in the Import dock

...
1. Ensure *no* [Environment](../../classes/class_environment.md#class-environment) resources use SDR-only features:

- Tonemap Mode: Filmic or ACES
- Glow Blend Mode: Soft Light
- Adjustments: Color Correction

1. Configure the [Renderer](../../classes/class_projectsettings.md#class-projectsettings-property-rendering-renderer-rendering-method)
   project setting to `mobile` or `forward_plus`.
2. Configure the [Rendering Device Driver](../../classes/class_projectsettings.md#class-projectsettings-property-rendering-rendering-device-driver)
   advanced project setting to `metal` for iOS and `d3d12` for Windows.
3. Configure the [Display Server Driver.linuxbsd](../../classes/class_projectsettings.md#class-projectsettings-property-display-display-server-driver-linuxbsd)
   advanced project setting to `wayland` and enable the [Prefer Wayland](../../classes/class_editorsettings.md#class-editorsettings-property-run-platforms-linuxbsd-prefer-wayland)
   editor setting.
4. Turn on the [HDR 2D](../../classes/class_projectsettings.md#class-projectsettings-property-rendering-viewport-hdr-2d) project
   setting and enable [use_hdr_2d](../../classes/class_viewport.md#class-viewport-property-use-hdr-2d) for all
   [SubViewports](../../classes/class_subviewport.md#class-subviewport) and [Windows](../../classes/class_window.md#class-window) that should support
   HDR output.
5. Turn on the [Request HDR Output](../../classes/class_projectsettings.md#class-projectsettings-property-display-window-hdr-request-hdr-output)
   project setting and enable [hdr_output_requested](../../classes/class_window.md#class-window-property-hdr-output-requested)
   for all other [Windows](../../classes/class_window.md#class-window) that should support HDR output.
...
The Godot editor will use HDR output for its main window when the [Request HDR Output](../../classes/class_projectsettings.md#class-projectsettings-property-display-window-hdr-request-hdr-output)
...
The number in parentheses next to the "HDR" text is the current [output max linear value](../../classes/class_window.md#class-window-method-get-output-max-linear-value)
which is described in the following sections. You can toggle the game's
[Window.hdr_output_requested](../../classes/class_window.md#class-window-property-hdr-output-requested) property in the game
window options menu:
...
[Window.get_output_max_linear_value()](../../classes/class_window.md#class-window-method-get-output-max-linear-value) and
...
[Window.get_output_max_linear_value()](../../classes/class_window.md#class-window-method-get-output-max-linear-value).

## Designing for HDR output

There are two primary approaches to make the most of HDR output: using the
[output max linear value](../../classes/class_window.md#class-window-method-get-output-max-linear-value) and using
tonemapping.

While both approaches can be used in the same project, tonemapping should be used to produce HDR
output from a [Viewport](../../classes/class_viewport.md#class-viewport) that uses lighting that exceeds the capabilities of an
...
The [output max linear value](../../classes/class_window.md#class-window-method-get-output-max-linear-value) should only be
...
[output max linear value](../../classes/class_window.md#class-window-method-get-output-max-linear-value) well suited for
[CanvasItems](../../classes/class_canvasitem.md#class-canvasitem) or unshaded materials in a scene that has no lighting or basic
lighting that otherwise does not exceed the capabilities of an SDR screen.

The [Viewport.own_world_3d](../../classes/class_viewport.md#class-viewport-property-own-world-3d) property can be used to
separate which [Viewports](../../classes/class_viewport.md#class-viewport) are affected by tonemapping and other
[WorldEnvironment](../../classes/class_worldenvironment.md#class-worldenvironment) effects.
...
through the [output max linear value](../../classes/class_window.md#class-window-method-get-output-max-linear-value). This
...
The [output max linear value](../../classes/class_window.md#class-window-method-get-output-max-linear-value) may change
...
frame or use the [output max linear value changed](../../classes/class_window.md#class-window-signal-output-max-linear-value-changed)
...
It is best to use this [output max linear value](../../classes/class_window.md#class-window-method-get-output-max-linear-value)
...
but less than the [output max linear value](../../classes/class_window.md#class-window-method-get-output-max-linear-value).
...
working with [CanvasItem](../../classes/class_canvasitem.md#class-canvasitem), it may be convenient to apply the resulting modified color
to the [modulate](../../classes/class_canvasitem.md#class-canvasitem-property-modulate) or
[self_modulate](../../classes/class_canvasitem.md#class-canvasitem-property-self-modulate) property with the base color of the
[CanvasItem](../../classes/class_canvasitem.md#class-canvasitem) set to [white](../../classes/class_color.md#class-color-constant-white). The following script
demonstrates this:
...
To produce HDR output without using the [output max linear value](../../classes/class_window.md#class-window-method-get-output-max-linear-value)
your scenes will need color values
that exceed what an SDR screen can present, so it is important to use a tonemapper like
[Reinhard](../../classes/class_environment.md#class-environment-constant-tone-mapper-reinhardt) or
[AgX](../../classes/class_environment.md#class-environment-constant-tone-mapper-agx) to handle display of these bright scene
...
Tonemappers in Godot use the [output max linear value](../../classes/class_window.md#class-window-method-get-output-max-linear-value)
to determine the output range that the screen is capable of presenting. For example, with the
[Reinhard](../../classes/class_environment.md#class-environment-constant-tone-mapper-reinhardt) tonemapper in Godot, linear
scene values in the range of `0.0` to [tonemap white](../../classes/class_environment.md#class-environment-property-tonemap-white)
are mapped to an output range of `0.0` to
[output max linear value](../../classes/class_window.md#class-window-method-get-output-max-linear-value).

![image](img/rendering_hdr_output_sdr_tonemap.webp)

With this approach, you can adjust [tonemap white](../../classes/class_environment.md#class-environment-property-tonemap-white)
to be sure that any linear scene value below [tonemap white](../../classes/class_environment.md#class-environment-property-tonemap-white)
...
While this behavior is perfectly stable in SDR, where the [output max linear value](../../classes/class_window.md#class-window-method-get-output-max-linear-value)
...
[Reinhard](../../classes/class_environment.md#class-environment-constant-tone-mapper-reinhardt) tonemapper will behave the same
as the [Linear](../../classes/class_environment.md#class-environment-constant-tone-mapper-linear) tonemapper when
[output max linear value](../../classes/class_window.md#class-window-method-get-output-max-linear-value) is equal to or higher than
[tonemap white](../../classes/class_environment.md#class-environment-property-tonemap-white). This allows for accurate color
reproduction on HDR screens that are capable of reproducing the original brighter scene values.
When [output max linear value](../../classes/class_window.md#class-window-method-get-output-max-linear-value) has increased
to be higher than [tonemap white](../../classes/class_environment.md#class-environment-property-tonemap-white), tonemap white
will be adjusted to match this output max linear value.

The [AgX](../../classes/class_environment.md#class-environment-constant-tone-mapper-agx) tonemapper behaves similar to
[Reinhard](../../classes/class_environment.md#class-environment-constant-tone-mapper-reinhardt) in this way, but its
[tonemap white](../../classes/class_environment.md#class-environment-property-tonemap-agx-white) is always multiplied by
[output max linear value](../../classes/class_window.md#class-window-method-get-output-max-linear-value). The
[Linear](../../classes/class_environment.md#class-environment-constant-tone-mapper-linear) tonemapper applies no tonemapping at
all; its [tonemap white](../../classes/class_environment.md#class-environment-property-tonemap-white) equals
[output max linear value](../../classes/class_window.md#class-window-method-get-output-max-linear-value) in all scenarios. The
[Filmic](../../classes/class_environment.md#class-environment-constant-tone-mapper-filmic) and
[ACES](../../classes/class_environment.md#class-environment-constant-tone-mapper-aces) tonemappers ignore
[output max linear value](../../classes/class_window.md#class-window-method-get-output-max-linear-value) entirely and always produce an
...
on [output max linear value](../../classes/class_window.md#class-window-method-get-output-max-linear-value), the results will
...
[output max linear value](../../classes/class_window.md#class-window-method-get-output-max-linear-value), then the glow
strength will change as well: a larger
[output max linear value](../../classes/class_window.md#class-window-method-get-output-max-linear-value) will produce a
stronger glow effect, which is generally an undesirable behavior.

## Absolute luminance values

When using HDR output, [output max linear value](../../classes/class_window.md#class-window-method-get-output-max-linear-value)
...
[output max linear value](../../classes/class_window.md#class-window-method-get-output-max-linear-value) of exactly `1.0`.
...
When in HDR mode, the [output max linear value](../../classes/class_window.md#class-window-method-get-output-max-linear-value)
...
[output max linear value](../../classes/class_window.md#class-window-method-get-output-max-linear-value) will decrease. In some cases when using
HDR mode with the highest reference luminance,
[output max linear value](../../classes/class_window.md#class-window-method-get-output-max-linear-value) will equal `1.0`, matching SDR behavior,

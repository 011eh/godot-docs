...
![Adjusting BoxMesh properties in the inspector](img/soft_body_box_mesh.webp)
...
![Adjusting SoftBody3D simulation properties in the inspector](img/soft_body_inspector.webp)
...
![Subdividing the PlaneMesh and placing it on the character's back](img/soft_body_cloak_subdivide.webp)
...
![Configuring the BoneAttachment3D node in the inspector](img/soft_body_cloak_bone_attach.webp)
...
![Pinning the SoftBody3D's points in the inspector](img/soft_body_cloak_pinned.webp)
...
![Configuring pinned points to be attached to the BoneAttachment3D node in the SoftBody3D inspector](img/soft_body_cloak_pinned_attach.webp)
...
![Setting up the collision exception in the SoftBody3D inspector](img/soft_body_cloak_ignore.webp)

Play the scene and the cloak should simulate correctly.

![Final result when running the project's main scene](img/soft_body_cloak_finish.webp)

...
Jolt supports the same type of interactions between [SoftBody3D](../../classes/class_softbody3d.md#class-softbody3d) and
[Area3D](../../classes/class_area3d.md#class-area3d) as Godot Physics, such as the wind and gravity properties found
on [Area3D](../../classes/class_area3d.md#class-area3d). Unlike Godot Physics however, Jolt also supports the various
overlap signals and methods found on [Area3D](../../classes/class_area3d.md#class-area3d), for when a [SoftBody3D](../../classes/class_softbody3d.md#class-softbody3d)
enters or exits an overlap with it, such as [body_entered](../../classes/class_area3d.md#class-area3d-signal-body-entered).

To revert back to the behavior of Godot Physics, where no overlap signals are
emitted, you need to configure the area's [collision_mask](../../classes/class_collisionobject3d.md#class-collisionobject3d-property-collision-mask)
such that there's no overlap with the soft body's [collision_layer](../../classes/class_collisionobject3d.md#class-collisionobject3d-property-collision-layer).
You can also filter out any [SoftBody3D](../../classes/class_softbody3d.md#class-softbody3d) in the signal connection yourself.

...
![Creating a physical skeleton in the editor](img/ragdoll_system_create_physical_skeleton.webp)
...
![Scene tree of the player scene after creating a physical skeleton](img/ragdoll_system_skeleton_scene_tree.webp)
...
![Adjusting joints in the inspector after selecting a PhysicalBone3D node](img/ragdoll_system_adjust_joints_inspector.webp)
...
![Adjusting collision shapes in the 3D editor](img/ragdoll_system_adjust_collision_shapes.webp)

This is the final result:

![Result after adjusting joints and collision shapes (player mesh is hidden for visibility)](img/ragdoll_system_result.webp)
...
![Layers and masks must be adjusted to these values in the inspector for each node](img/ragdoll_system_collision_layers_masks.webp)

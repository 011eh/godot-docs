...
![Changing import type to Font Data (Image Font)](img/using_fonts_bitmap_font_from_image_import_options.webp)
...
![Bitmap font example](img/using_fonts_monospace_bitmap_font_example.webp)

The following import options can be used to import the above font image
successfully:

![Import options to use for the above example font](img/using_fonts_bitmap_font_from_image_example_configuration.webp)
...
![Diagram showing the advance and offset values being used in character ranges.](img/using_fonts_bitmap_font_advance_offsets_diagram.webp)
...
![image](img/using_fonts_bitmap_kerning_pairs_example.webp)
...
![Font outline example](img/using_fonts_outline_example.webp)
...
![Configuring font shadow in a Label node](img/using_fonts_shadow.webp)

The result should look like this:

![Font shadow example](img/using_fonts_shadow_example.webp)
...
![Font antialiasing comparison](img/using_fonts_antialiasing_comparison.webp)
...
![Font hinting comparison](img/using_fonts_hinting_comparison.webp)
...
![Comparison of font rasterization methods](img/using_fonts_rasterized_vs_msdf_comparison.webp)
...
![Enabling MSDF in the font's import options](img/using_fonts_msdf_import_options.webp)
...
![Default appearance when trying to use emoji in a label](img/using_fonts_emoji_placeholder_characters.webp)

After adding a font to display emoji such as
[Noto Color Emoji](https://fonts.google.com/noto/specimen/Noto+Color+Emoji),
you get the expected result:

![Correct appearance after adding an emoji font to the label](img/using_fonts_emoji_correct_characters.webp)
...
![image](img/using_fonts_font_variation_create.webp)![image](img/using_fonts_font_variation_load.webp)
...
![Faux bold/italic (top), real bold/italic (bottom). Normal font used: Open Sans SemiBold](img/using_fonts_faux_bold_italic_vs_real_bold_italic.webp)
...
![image](img/using_fonts_system_font_create.webp)![image](img/using_fonts_system_font_specify.webp)
...
![Adding a new prerendering configuration in the Advanced Import Settings dialog](img/using_fonts_advanced_import_settings_prerender_new_configuration.webp)
...
![Enabling prerendering in the Advanced Import Settings dialog with the Glyphs from the Translations tab](img/using_fonts_advanced_import_settings_prerender_translation.webp)
...
![Enabling prerendering in the Advanced Import Settings dialog, Glyphs from the Text tab](img/using_fonts_advanced_import_settings_prerender_text.webp)
...
![Enabling prerendering in the Advanced Import Settings dialog, Glyphs from the Character Map tab](img/using_fonts_advanced_import_settings_prerender_character_map.webp)

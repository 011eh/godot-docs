...
![Comparison between standard FileDialog (left) and native file dialog (right) on macOS](img/creating_applications_native_file_dialog.webp)
...
![Comparison between standard MenuBar (left), MenuBar with native popups (middle), and native menu (right) on macOS](img/creating_applications_native_menu.webp)
...
![Custom options added to the system Window menu on macOS](img/creating_applications_native_menu_window.webp)
...
![Comparison between standard window decorations (top) and client-side decorations (bottom) on macOS](img/creating_applications_client_side_decoration.webp)
...
![Safe title margins when using client-side decorations on macOS](img/creating_applications_client_side_decoration_margins.webp)
...
![Progress reporting in the Dock on macOS](img/creating_applications_progress_reporting.webp)

This is often accomplished by synchronizing a [ProgressBar](../../classes/class_progressbar.md#class-progressbar) node's
...
You can also use
[Window.request_attention()](../../classes/class_window.md#class-window-method-request-attention)
...
The Godot editor's own [self-contained mode](../io/data_paths.md#doc-data-paths-self-contained-mode)

...
#### NOTE
RPC methods must be defined on [Node](../../classes/class_node.md#class-node)-derived classes. Attempting
...
You can use the [SceneMultiplayer](../../classes/class_scenemultiplayer.md#class-scenemultiplayer)'s built-in authentication mechanism for this.
...
As soon as both the client's and the server's [complete_auth()](../../classes/class_scenemultiplayer.md#class-scenemultiplayer-method-complete-auth)

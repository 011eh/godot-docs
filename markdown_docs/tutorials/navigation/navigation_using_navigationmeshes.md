...
![Navigation mesh polygon convex vs concave comparison](img/nav_mesh_vs_physics.webp)
...
![Navigation mesh baking steps](img/nav_mesh_baking_steps.gif)
...
![image](img/nav_region_baking_01.webp)![image](img/nav_mesh_mini_2d.webp)
...
![image](img/nav_mesh_bake_toolbar.webp)![image](img/nav_mesh_mini_3d.webp)
...
![Building navigation mesh chunks](img/navmesh_chunk_build.gif)
...
![Navigation mesh chunk with bake bound and border size](img/navmesh_bound_bordersize.webp)
...
![Navigation mesh chunks with gaps](img/navmesh_chunk_gaps.webp)
...
![Navigation mesh chunks without gaps](img/navmesh_chunks.webp)
...
![NavigationObstacle3D unwanted geometry discard](img/nav_mesh_obstacles_discard.webp)

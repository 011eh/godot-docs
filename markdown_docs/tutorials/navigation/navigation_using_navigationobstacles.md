...
![Navigation obstacles affecting navigation mesh baking](img/nav_mesh_obstacles.webp)
...
![Navigation obstacles discard of unwanted navigation mesh](img/nav_mesh_obstacles_discard.webp)
...
![Static obstacle drawn in the editor to block or contain navigation agents](img/nav_static_obstacle_build.gif)

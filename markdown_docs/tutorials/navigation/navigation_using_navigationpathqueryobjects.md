...
![Path post-processing differences depending on navigation mesh polygon layout](img/path_postprocess_diff.webp)
...
![Path point difference with or without path simplification](img/path_simplification_diff.webp)
...
![Clipping returned paths to specific distances](img/path_clip_and_limits.gif)

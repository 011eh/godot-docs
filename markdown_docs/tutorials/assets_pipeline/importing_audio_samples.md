...
![Import options in the Import dock after selecting a WAV file in the FileSystem dock](img/importing_audio_samples_import_options_wav.webp)

The set of options available after selecting an Ogg Vorbis or MP3 file is different:

![Import options in the Import dock after selecting an MP3 file in the FileSystem dock](img/importing_audio_samples_import_options_mp3.webp)
...
![Advanced dialog when double-clicking an Ogg Vorbis or MP3 file in the FileSystem dock](img/importing_audio_samples_advanced_import_settings.webp)

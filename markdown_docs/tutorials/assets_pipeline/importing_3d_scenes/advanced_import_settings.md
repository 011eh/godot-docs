...
![image](img/importing_3d_scenes_advanced_import_settings_button.webp)
...
![Advanced Import Settings dialog (Scene tab)](img/importing_3d_scenes_advanced_import_settings_scene.webp)
...
![Selecting a node in the Advanced Import Settings dialog (Scene tab)](img/importing_3d_scenes_advanced_import_settings_node.webp)
...
![Advanced Import Settings dialog (Meshes tab)](img/importing_3d_scenes_advanced_import_settings_meshes.webp)
...
![Advanced Import Settings dialog (Materials tab)](img/importing_3d_scenes_advanced_import_settings_materials.webp)
...
![Extracting all built-in materials to external resources in the Advanced Import Settings dialog](img/importing_3d_scenes_advanced_import_settings_extract_materials.webp)

After choosing this option, select a folder to extract material `.tres` files
to, then confirm the extraction:

![Confirming material extraction in the Advanced Import Settings subdialog](img/importing_3d_scenes_advanced_import_settings_extract_materials_confirm.webp)

...
![Diagram explaining the runtime import and export process for glTF files in Godot](img/importing_3d_scenes_available_formats_gltf_runtime.webp)
...
![Diagram explaining the editor import process for glTF files in Godot](img/importing_3d_scenes_available_formats_gltf_editor.webp)
...
![Diagram explaining the import process for Blender files in Godot](img/importing_3d_scenes_available_formats_blend.webp)
...
![Diagram explaining the import process for FBX files in Godot  via FBX2glTF](img/importing_3d_scenes_available_formats_fbx.webp)

...
![Import dock after selecting a 3D scene in the FileSystem dock](img/importing_3d_scenes_import_dock.webp)
...
![Changing the import type to Animation Library in the Import dock](img/importing_3d_scenes_changing_import_type.webp)
...
![Dialog when opening an imported 3D scene in the editor](img/importing_3d_scenes_create_inherited_scene_dialog.webp)

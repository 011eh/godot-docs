...
If **Extensions Support** is enabled, [GDExtensions](../../engine_details/engine_api/gdextension/what_is_gdextension.md#doc-what-is-gdextension)
...
![Unregistering the service worker in Chromium-based browsers' DevTools](img/exporting_for_web_reset_unregister_service_worker_chromium.webp)
...
![Unregistering the service worker in Firefox's DevTools](img/exporting_for_web_reset_unregister_service_worker_firefox.webp)

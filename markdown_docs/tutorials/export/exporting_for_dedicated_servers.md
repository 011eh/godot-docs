...
![Choosing the **Export as dedicated server** export mode in the export preset](img/exporting_for_dedicated_servers_export_mode.webp)
...
![Choosing resources to keep, keep with stripped visuals or remove](img/exporting_for_dedicated_servers_export_resources.webp)

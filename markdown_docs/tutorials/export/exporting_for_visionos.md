...
see [Compiling for visionOS](../../engine_details/development/compiling/compiling_for_visionos.md#doc-compiling-for-visionos).

Exporting instructions for visionOS are currently identical to
[Compiling for iOS](../../engine_details/development/compiling/compiling_for_ios.md#doc-compiling-for-ios), except you should add a **visionOS**

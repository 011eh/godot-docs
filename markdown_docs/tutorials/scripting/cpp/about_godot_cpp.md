...
godot-cpp is built with the [GDExtension system](../../../engine_details/engine_api/gdextension/index.md#doc-gdextension), which allows access to Godot in almost the

...
![Linked Vector2i property with the "px" suffix](img/gdscript_exports_linked_vector.webp)

[This hint](../../../classes/class_@globalscope.md#class-globalscope-constant-property-hint-link) is effective
...
#### NOTE
Using `@export` variables for [Resource](../../../classes/class_resource.md#class-resource) objects
...
[Resource](../../../classes/class_resource.md#class-resource) object but load it manually when you need
it (which, for example, is often the case for
[PackedScenes](../../../classes/class_packedscene.md#class-packedscene) containing a whole level), use

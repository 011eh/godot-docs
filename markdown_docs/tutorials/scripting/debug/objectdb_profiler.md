...
![ObjectDB profiler summary with no snapshots taken](img/objectdb_profiler_summary_no_snapshots.webp)
...
![ObjectDB profiler summary with one snapshot taken](img/objectdb_profiler_summary_snapshot.webp)
...
![Diff Against dropdown in the bottom-left corner of the ObjectDB profiler](img/objectdb_profiler_summary_diff_against.webp)

The summary page will then show the differences between the two snapshots:

![Two snapshots being compared in the Summary tab](img/objectdb_profiler_summary_snapshot_diff.webp)
...
![One snapshots being viewed in the Classes tab](img/objectdb_profiler_classes.webp)
...
![Two snapshots being compared in the Classes tab. Here, column A is ``second_session``, column B is ``first_session``](img/objectdb_profiler_classes_diff.webp)

You can click on a class in the list on the right to view it in the inspector.

![A selected class instance being viewed in the inspector](img/objectdb_profiler_classes_inspector.webp)
...
![The Objects tab being used to view objects in a "top-down" manner](img/objectdb_profiler_objects_top_down.webp)
...
![The Objects tab being used to view objects in a "bottom-up" manner](img/objectdb_profiler_objects_bottom_up.webp)

### Nodes

Next, the Nodes tab shows the scene tree at the time the snapshot was taken.

![The Nodes tab being used to view the scene tree](img/objectdb_profiler_nodes.webp)
...
![Separate diff view in the Nodes tab](img/objectdb_profiler_nodes_diff_separate.webp)
...
![Combined diff view in the Nodes tab](img/objectdb_profiler_nodes_diff_combined.webp)
...
![Orphan nodes at the end of the nodes tree in the ObjectDB profiler](img/objectdb_profiler_nodes_orphan.webp)
...
![The RefCounted tab being used to view RefCounted instances](img/objectdb_profiler_refcounted.webp)

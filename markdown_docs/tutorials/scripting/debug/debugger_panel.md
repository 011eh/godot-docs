...
![Visual Profiler tab after clicking Start, waiting for a few seconds, then clicking Stop](img/debugger_visual_profiler_results.webp)
...
[debugger/profiler_target_fps](../../../classes/class_editorsettings.md#class-editorsettings-property-debugger-profiler-target-fps)
...
![Example results from a 2D scene in the Visual Profiler](img/debugger_visual_profiler_2d_example.webp)
...
![Example results from a 3D scene in the Visual Profiler](img/debugger_visual_profiler_3d_example.webp)

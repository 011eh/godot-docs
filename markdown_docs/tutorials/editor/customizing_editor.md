...
![Resizing a dock in the editor](img/editor_ui_resize_dock.webp)
...
![Moving a dock in the editor](img/editor_ui_move_dock.webp)
...
![Splitting the script editor to its own window](img/editor_ui_split_script_editor.webp)

To split the shader editor to its own window, click the corresponding button in
the top-right corner of the script editor:

![Splitting the shader editor to its own window](img/editor_ui_split_shader_editor.webp)
...
![The Editor Settings window](img/editor_settings.webp)

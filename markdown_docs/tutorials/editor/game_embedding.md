...
![Accessing the Game embedding main screen](img/game_embedding_main_screen.webp)

Once on the Game main screen, click the dropdown menu in the top-right corner of the Game bar:

![Game embedding mode dropdown](img/game_embedding_mode_dropdown.webp)
...
- **Fixed Size**  *(default)*: Set the viewport size to a fixed resolution, as configured in the Project Settings.
  If both [display/window/size/window_width_override](../../classes/class_projectsettings.md#class-projectsettings-property-display-window-size-window-width-override)
  and [display/window/size/window_height_override](../../classes/class_projectsettings.md#class-projectsettings-property-display-window-size-window-height-override)
...
![Game bar at the top of the embedded game window](img/game_embedding_game_bar.webp)
...
[Engine.time_scale](../../classes/class_engine.md#class-engine-property-time-scale) at runtime, it will
be multiplied by the value set here.

![Game speed dropdown on the left of the Game bar](img/game_embedding_game_speed_dropdown.webp)

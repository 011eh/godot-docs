...
to the file name. For example, the ![script](img/Script.webp) icon means that it is a GDScript.
the ![scriptcsharp](img/ScriptCSharp.webp) means it is a C# script. The ![documentation](img/Documentation.webp) means that this is a
built-in class reference. Finally, the ![toolscript](img/ToolScript.webp) means it is a currently running
...
![image](img/text_editor_menu.webp)

The **File** menu provides the following options:

![image](img/text_editor_file_menu.webp)
...
![image](img/text_editor_edit_menu.webp)
...
![image](img/text_editor_search_menu.webp)
...
![image](img/text_editor_goto_menu.webp)
...
In the script, to the left of function definitions, you might see additional icons. The ![override](img/override.webp)
...
function. Clicking it opens the documentation of the original function. The ![receiver](img/receiver.webp) icon means
that it is a receiving method of a signal. Clicking it shows where the signal is coming
from. A ![foldable](img/Foldable.webp) icon to the left of the line denotes a foldable block. You can
...
![image](img/text_editor_coding_area_indicators.webp)

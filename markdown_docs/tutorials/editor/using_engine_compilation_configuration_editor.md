...
![Opening the Engine Compilation Configuration Editor](img/engine_compilation_configuration_editor_detect.webp)
...
![Updated features list after using feature detection (example from the 3D platformer demo)](img/engine_compilation_configuration_editor_detected.webp)
...
- Features that are used in [GDExtensions](../../engine_details/engine_api/gdextension/index.md#doc-gdextension), unless the language binding

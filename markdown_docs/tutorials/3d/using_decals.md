...
![Dirt added on top of level geometry using decals](img/decals_dirt.webp)
...
![Blob shadow under object comparison](img/decals_blob_shadow.webp)
...
![VisualInstance3D Sorting Offset comparison on Decals](img/decals_sorting_offset.webp)

...
![An example 3D game demo created using Godot](img/godot-tps-demo.webp)
...
![3D coordinate systems comparison chart](img/introduction_to_3d_coordinate_systems.webp)

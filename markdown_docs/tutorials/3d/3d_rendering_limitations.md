...
![Color banding comparison (contrast increased for more visibility)](img/3d_rendering_limitations_banding.webp)
...
![Z-fighting comparison (before and after tweaking the scene by offsetting the Label3D away from the floor)](img/3d_rendering_limitations_z_fighting.webp)
...
![Transparency sorting comparison (alpha-blended materials on the left, alpha scissor materials on the right)](img/3d_rendering_limitations_transparency_sorting.webp)

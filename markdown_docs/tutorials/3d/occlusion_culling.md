...
![Example scene with an occlusion culling-friendly layout](img/occlusion_culling_scene_example.png)
...
![Example scene with occlusion culling disabled (wireframe)](img/occlusion_culling_disabled.png)
...
![Example scene with occlusion culling enabled (wireframe)](img/occlusion_culling_enabled.png)

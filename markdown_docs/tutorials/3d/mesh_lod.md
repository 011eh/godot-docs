...
![From most detailed (left) to least detailed (right), shaded view](img/mesh_lod_comparison_shaded.png)

Here's the same image with wireframe rendering to make the decimation easier to see:

![From most detailed (left) to least detailed (right), wireframe view](img/mesh_lod_comparison_wireframe.png)
...
![Changing the import type on an OBJ file in the Import dock](img/mesh_lod_obj_import.png)
...
![Disabling mesh LOD in the 3D viewport's top-left menu](img/mesh_lod_disable_lod.png)

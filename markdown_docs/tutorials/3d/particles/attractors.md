...
![Particle attractors](img/particle_attractor.webp)
...
![Common particle attractor properties](img/particle_attractor_common.webp)
...
![Different attractor attenuation curves](img/particle_attractor_curve.webp)
...
![Different attractor directionality values](img/particle_attractor_direction.webp)
...
![Particle attractor box](img/particle_attractor_box_entry.webp)
...
![Box attractor parts particle field](img/particle_attractor_box.webp)

## Sphere attractors

![Particle attractor sphere](img/particle_attractor_sphere_entry.webp)
...
![Sphere attractor parts particle field](img/particle_attractor_sphere.webp)

## Vector field attractors

![Particle attractor vector field](img/particle_attractor_vector_entry.webp)
...
![Mapping from texture to vector field](img/particle_attractor_vector_mapping.webp)
...
![Vector field attractor in a field of particles](img/particle_attractor_vector.webp)

...
![Three spheres showing the Per-Pixel, Per-Vertex, and Unshaded modes.](img/standard_material_shading_modes.webp)
...
![Two cubes with a brick texture, one shaded and one unshaded.](img/standard_material_shading_modes_textured.webp)

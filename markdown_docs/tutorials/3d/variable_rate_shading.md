...
![Variable rate shading disabled in textured scene](img/variable_rate_shading_textured_disabled.webp)![Variable rate shading enabled in textured scene (lower quality, but higher performance)](img/variable_rate_shading_textured_enabled.webp)
...
![Variable rate shading disabled in untextured scene](img/variable_rate_shading_untextured_disabled.webp)![Variable rate shading enabled in untextured scene (lower quality, but higher performance)](img/variable_rate_shading_untextured_enabled.webp)
...
![Example VRS density map texture, simulating foveated rendering](img/variable_rate_shading_texture_example.webp)

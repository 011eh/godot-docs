...
![image](img/lights_and_shadows_omni_projector_example.webp)![image](img/lights_and_shadows_omni_projector.webp)
...
![image](img/lights_and_shadows_spot_projector_example.webp)![image](img/lights_and_shadows_spot_projector.webp)
...
Godot provides the [AreaLight3D](../../classes/class_arealight3d.md#class-arealight3d) node for this purpose, which emits
light from a rectangular area. The node only emits light and has no other visual
representation in the scene. The screenshots below use a [Sprite3D](../../classes/class_sprite3d.md#class-sprite3d)

...
![Reflection probe disabled. Environment sky is used as a fallback.](img/gi_none.webp)![Reflection probe enabled.](img/gi_none_reflection_probe.webp)![Reflection probe enabled.](img/gi_lightmap_gi_indirect_only_reflection_probe.webp)
...
![Reflections in a room using ReflectionProbe only.](img/reflection_probes_reflection_probe.webp)![Reflections in a room using screen-space reflections only.](img/reflection_probes_ssr.webp)![Reflections in a room using ReflectionProbe and screen-space reflections together.](img/reflection_probes_reflection_probe_ssr.webp)

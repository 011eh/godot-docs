...
![A 3D scene without any form of global illumination (only constant environment lighting). The box and sphere near the camera are both dynamic objects.](img/gi_none.webp)
...
- **VoxelGI:** ![average](img/score_average.webp) Good reflections and indirect lighting, but beware of leaks.
  - Due to its voxel-based nature, VoxelGI will exhibit light leaks if walls and floors are too thin.
    ...
    this.
    ![VoxelGI in action.](img/gi_voxel_gi.webp)
- **SDFGI:** ![average](img/score_average.webp) Good reflections and indirect lighting, but beware of leaks and visible cascade shifts.
  - GI level of detail varies depending on the distance
    ...
    ![SDFGI in action.](img/gi_sdfgi.webp)
- **Screen-space indirect lighting (SSIL):** ![average](img/score_average.webp) Good *secondary* source of indirect lighting, but no reflections.
  - SSIL is designed to be used as a complement to another GI technique such as
    ...
    ![SSIL in action (without any other GI technique). Notice the emissive lighting around the yellow box.](img/gi_ssil_only.webp)
- **LightmapGI:** ![good](img/score_good.webp) Excellent indirect lighting, decent reflections (optional).
  - This is the only technique where the number of light bounces
    ...
    ![LightmapGI in action. Only indirect lighting is baked here, but direct light can also be baked.](img/gi_lightmap_gi_indirect_only.webp)
- **ReflectionProbe:** ![average](img/score_average.webp) Good reflections, but poor indirect lighting.
  - Indirect lighting can be disabled, set to a constant color spread throughout
    ...
    ![ReflectionProbe in action (without any other GI technique). Notice the reflective sphere.](img/gi_none_reflection_probe.webp)

...
![LightmapGI disabled.](img/gi_none.webp)![LightmapGI enabled (with indirect light baked only).](img/gi_lightmap_gi_indirect_only.webp)![LightmapGI enabled (with direct and indirect light baked).](img/gi_lightmap_gi_direct_and_indirect.webp)
...
![Comparison between shadowmask modes](img/lightmap_gi_shadowmask.webp)
...
![Comparison between denoising disabled and enabled](img/lightmap_gi_denoiser_comparison.webp)
...
![Comparison between JNLM denoiser strength values](img/lightmap_gi_denoiser_jnlm_strength.webp)
...
![Comparison between JNLM and OIDN denoisers](img/lightmap_gi_denoiser_jnlm_vs_oidn.webp)

...
![Example of using glow in a 2D scene](img/environment_and_post_processing_glow_in_2d.webp)
...
![Example of using glow to blur the 2D rendering in the menu's background](img/environment_and_post_processing_glow_blur.webp)

...
To check if a connected controller has motion sensors, use [Input.has_joy_motion_sensors()](../../classes/class_input.md#class-input-method-has-joy-motion-sensors).

Motion sensors are disabled by default to avoid draining the controller battery when games don't use those features.
To enable them, call [Input.set_joy_motion_sensors_enabled()](../../classes/class_input.md#class-input-method-set-joy-motion-sensors-enabled).
...
[Input.start_joy_motion_sensors_calibration()](../../classes/class_input.md#class-input-method-start-joy-motion-sensors-calibration) documentation.
...
Note that before using the gyroscope's data, we must first calibrate it by calling [Input.start_joy_motion_sensors_calibration()](../../classes/class_input.md#class-input-method-start-joy-motion-sensors-calibration)
and [Input.stop_joy_motion_sensors_calibration()](../../classes/class_input.md#class-input-method-stop-joy-motion-sensors-calibration).
...
you can read its reported values by using [Input.get_joy_gyroscope()](../../classes/class_input.md#class-input-method-get-joy-gyroscope).

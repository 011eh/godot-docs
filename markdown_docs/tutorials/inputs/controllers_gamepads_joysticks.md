...
set [ProjectSettings.input_devices/joypads/ignore_joypad_on_unfocused_application](../../classes/class_projectsettings.md#class-projectsettings-property-input-devices-joypads-ignore-joypad-on-unfocused-application) to `true`.
Alternatively, you can also set [Input.ignore_joypad_on_unfocused_application](../../classes/class_input.md#class-input-property-ignore-joypad-on-unfocused-application) to `true`.

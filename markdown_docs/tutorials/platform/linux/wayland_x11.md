...
`--display-server <x11|wayland>` [command line argument](../../editor/command_line_tutorial.md#doc-command-line-tutorial)
...
Godot supports [HDR output](../../rendering/hdr_output.md#doc-hdr-output) on Linux since 4.7. However,

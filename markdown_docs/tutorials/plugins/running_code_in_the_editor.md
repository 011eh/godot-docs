...
![Creating an editor script in the script editor creation dialog](img/running_code_in_the_editor_creating_editor_script.webp)
...
denoted by the [GlobalClass](../scripting/c_sharp/c_sharp_global_classes.md#doc-c-sharp-global-classes)
attribute.
...
[EditorInterface.mark_scene_as_unsaved()](../../classes/class_editorinterface.md#class-editorinterface-method-mark-scene-as-unsaved)
after modifications, or use [EditorUndoRedoManager](../../classes/class_editorundoredomanager.md#class-editorundoredomanager) for undo support.

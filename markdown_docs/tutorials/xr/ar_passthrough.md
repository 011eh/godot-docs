...
implementation is now responsible for applying the correct platform-dependent method <sup>1</sup>.
...
* As we are making the surface opaque if in shadow, we can have virtual
  objects cast shadows on real world objects <sup>2</sup>.

![Image showing shadow to opacity being used to show the user's desk.](img/xr_passthrough_example.webp)

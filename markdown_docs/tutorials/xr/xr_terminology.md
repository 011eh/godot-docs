...
[XRServer](../../classes/class_xrserver.md#class-xrserver) and related APIs. This system abstracts away platform
...
[Setting up XR](setting_up_xr.md#doc-setting-up-xr) for how to get started.
...
See [AR passthrough](ar_passthrough.md#doc-openxr-passthrough) for an example of AR using the XR system.

...
|------------------------|--------------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Godot 4.8<br/>(master) | Q4 2026 (estimate) | ![unstable](img/unstable.png) *Development.* Receives new features, usability and<br/>performance improvements, as well as bug fixes, while under development. |
| Godot 4.7              | June 2026          | ![supported](img/supported.png) Receives fixes for bugs and security issues, as well as<br/>patches that enable platform support.                              |
| Godot 4.6              | January 2026       | ![supported](img/supported.png) Receives fixes for bugs and security issues, as well as<br/>patches that enable platform support.                              |
| Godot 4.5              | September 2025     | ![partial](img/partial.png) Receives fixes for security and platform support issues only.                                                                      |
| Godot 4.4              | March 2025         | ![eol](img/eol.png) No longer supported (last update: 4.4.1).                                                                                                  |
| Godot 4.3              | August 2024        | ![eol](img/eol.png) No longer supported (last update: 4.3).                                                                                                    |
| Godot 4.2              | November 2023      | ![eol](img/eol.png) No longer supported (last update: 4.2.2).                                                                                                  |
| Godot 4.1              | July 2023          | ![eol](img/eol.png) No longer supported (last update: 4.1.4).                                                                                                  |
| Godot 4.0              | March 2023         | ![eol](img/eol.png) No longer supported (last update: 4.0.4).                                                                                                  |
| Godot 3.7<br/>(3.x)    | No ETA for now     | ![supported](img/supported.png) *Beta.* Receives new features, usability and performance<br/>improvements, as well as bug fixes, while under development.      |
| Godot 3.6              | September 2024     | ![supported](img/supported.png) Receives fixes for bugs and security issues, as well as<br/>patches that enable platform support.                              |
| Godot 3.5              | August 2022        | ![eol](img/eol.png) No longer supported (last update: 3.5.3).                                                                                                  |

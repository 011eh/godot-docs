...
- Supports [tracing profilers](../engine_details/development/profiling/index.md#doc-tracing-profilers) like
  [Tracy](../engine_details/development/profiling/tracy.md#doc-profiler-tracy) and [Perfetto](../engine_details/development/profiling/perfetto.md#doc-profiler-perfetto) for deeper optimization tasks.
- Any script can be [run in the editor](../tutorials/plugins/running_code_in_the_editor.md#doc-running-code-in-the-editor)
...
- Optional [game embedding](../tutorials/editor/game_embedding.md#doc-game-embedding) to run the project in a panel within the editor.
...
- [Oversampling](../tutorials/rendering/multiple_resolutions.md#doc-multiple-resolutions-font-and-image-oversampling) for SVG images
  using the [DPITexture](../classes/class_dpitexture.md#class-dpitexture) import type. This allows for sharper results when scaling
  up the texture by re-rasterizing the SVG source image to a new resolution at run-time.
  - Oversampling can optionally take individual [CanvasItem](../classes/class_canvasitem.md#class-canvasitem) scales into
...
- [HDR output](../tutorials/rendering/hdr_output.md#doc-hdr-output) on supported platforms and renderers.
...
- [Directional lights](../tutorials/3d/lights_and_shadows.md#doc-lights-and-shadows-directional-light) (sun/moon).
- [Omnidirectional lights](../tutorials/3d/lights_and_shadows.md#doc-lights-and-shadows-omni-light).
- [Spot lights](../tutorials/3d/lights_and_shadows.md#doc-lights-and-shadows-spot-light) with adjustable cone angle and attenuation.
- [Rectangular area lights](../tutorials/3d/lights_and_shadows.md#doc-lights-and-shadows-area-light) with an optional texture
...
- Custom shaders can procedurally generate and modify textures in real-time using
  [DrawableTexture2D](../classes/class_drawabletexture2d.md#class-drawabletexture2d).
...
- Support for polyphony (playing several sounds from a single [AudioStreamPlayer](../classes/class_audiostreamplayer.md#class-audiostreamplayer)
  node).
...
- [AudioListener2D](../classes/class_audiolistener2d.md#class-audiolistener2d) and [AudioListener3D](../classes/class_audiolistener3d.md#class-audiolistener3d) nodes to listen from a position
...
- *Audio:*
  > - WAV with optional  or IMA-ADPCM compression.
  > - Ogg Vorbis.
  > - MP3.
...
- [Gamepad input](../tutorials/inputs/controllers_gamepads_joysticks.md#doc-controllers-gamepads-joysticks)
  (up to 8 simultaneous controllers).
  - Support for [changing the LED color](../tutorials/inputs/controller_features.md#doc-controller-features-led-color)
    on supported controllers.
  - Support for [reading motion sensors](../tutorials/inputs/controller_features.md#doc-controller-features-motion-sensors)
...
- Support for [pseudolocalization](../tutorials/i18n/pseudolocalization.md#doc-pseudolocalization) to test your project
...
- [Virtual joystick](../classes/class_virtualjoystick.md#class-virtualjoystick) and [buttons](../classes/class_touchscreenbutton.md#class-touchscreenbutton)
  for touch input.
...
- Text entry using [LineEdit](../classes/class_lineedit.md#class-lineedit) (single line), [TextEdit](../classes/class_textedit.md#class-textedit)
  (multiple lines), and [CodeEdit](../classes/class_codeedit.md#class-codeedit) (supports syntax highlighting,
...
- Containers to place GUI elements automatically following certain rules.
  ...
  > - [Foldable section](../classes/class_foldablecontainer.md#class-foldablecontainer) layouts.

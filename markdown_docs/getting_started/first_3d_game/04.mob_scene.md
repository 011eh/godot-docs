...
![image4](img/05.box_final_size.png)
...
![image5](img/06.visibility_notifier.webp)

Resize it using the orange dots until it covers the entire 3D model.

![image6](img/07.visibility_notifier_bbox_resized.png)
...
![image7](img/08.mob_attach_script.webp)
...
![image9](img/10.node_dock.webp)

Connect the signal to the `Mob`

![image10](img/11.connect_signal.webp)

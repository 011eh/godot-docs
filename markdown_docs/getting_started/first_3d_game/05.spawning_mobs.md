...
![image0](img/01.monsters_path_preview.png)
...
![image1](img/02.project_settings.webp)
...
![image2](img/03.window_settings.webp)
...
![image3](img/04.camera_preview.png)
...
![image4](img/05.cylinders_node.webp)

In the *Inspector*, assign a *CylinderMesh* to the *Mesh* property.

![image5](img/06.cylinder_mesh.webp)
...
![image8](img/09.toggle_grid_snap.webp)

Move the cylinder so it's right outside the camera's view in the top-left
corner.

![image9](img/10.place_first_cylinder.png)
...
![image10](img/11.both_cylinders_selected.png)

Move them to the right by dragging the red X axis.

![image11](img/12.four_cylinders.png)
...
![image12](img/13.selecting_all_cylinders.webp)
...
![image13](img/14.multi_material_selection.webp)
...
![image15](img/16.cylinders_fold.webp)
...
![image16](img/17.points_options.webp)
...
![image17](img/18.close_path.webp)

Your path should look like this.

![image18](img/19.path_result.png)
...
![image19](img/20.spawn_nodes.webp)
...
![image23](img/23.timeout_signal.webp)

Connect it to the *Main* node.

![image24](img/24.connect_timer_to_main.webp)
...
![image25](img/25.spawn_result.png)

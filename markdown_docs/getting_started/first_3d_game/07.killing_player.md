...
![image0](img/01.adding_area_node.webp)

In the *Inspector*, assign a cylinder shape to it.

![image1](img/02.cylinder_shape.webp)
...
![image2](img/03.cylinder_in_editor.png)
...
![image3](img/04.mob_detector_properties.webp)
...
![image4](img/05.body_entered_signal.webp)
...
![image5](img/06.player_hit_signal.webp)

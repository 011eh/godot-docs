...
![image1](img/animation_player_dock.webp)
...
![image2](img/02.new_animation.webp)

Name the animation "float".

![image3](img/03.float_name.webp)

Once you've created the animation, the timeline appears with numbers representing
time in seconds.

![image4](img/03.timeline.webp)

We want the animation to start playback automatically at the start of the game.
Also, it should loop.

To do so, you can click the autoplay button (![Autoplay](img/autoplay_button.webp)) in the animation toolbar
and the looping arrows, respectively.

![image5](img/04.autoplay_and_loop.webp)
...
![image9](img/09.creating_first_keyframe.webp)

![image](img/curves.webp)
...
![image10](img/10.initial_keys.webp)
...
![animation_final_keyframes](img/animation_final_keyframes.webp)
...
![image14](img/14.play_button.webp)
...
![image18](img/18.ease_out_second_rotation_key.webp)

Do the opposite for the second position keyframe, dragging it to the right.

![image19](img/19.ease_in_second_translation_key.webp)

Your animation should look something like this.

![image20](img/20.float_animation.gif)
...
![image21](img/21.script_icon.webp)
...
Next, make sure that the autoplay button (![Autoplay](img/autoplay_button.webp)) and the looping

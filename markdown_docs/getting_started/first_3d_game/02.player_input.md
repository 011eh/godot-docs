...
![image](img/add_character_body3D.webp)
...
![image](img/add_capsuleshape3d.webp)

The sphere's wireframe appears below the character.

![image](img/sphere_shape.png)
...
![image](img/moving_the_sphere_up.png)
...
![image](img/toggling_visibility.webp)
...
![image](img/project_settings.webp)
...
![image](img/adding_action.webp)

Create the following five actions:

![image](img/actions_list_empty.webp)
...
![image](img/left_inputmap.webp)

Bind also the `A` key, onto the action `move_left`.

![image](img/keyboard_keys.webp)
...
![image](img/joystick_axis_input.webp)

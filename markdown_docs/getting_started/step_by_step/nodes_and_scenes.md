...
playable character that the camera follows using a [CharacterBody2D](../../classes/class_characterbody2d.md#class-characterbody2d)
...
#### SEE ALSO
See [Game embedding](../../tutorials/editor/game_embedding.md#doc-game-embedding) for more information about the Game window that appears

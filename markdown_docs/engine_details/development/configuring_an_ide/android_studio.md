...
- **lib** module:
  ...
  > - The generated [Godot Android library](../../../tutorials/platform/android/android_library.md#doc-android-library) is made available for other Android modules / projects via [MavenCentral](https://central.sonatype.com/artifact/org.godotengine/godot), along with [its documentation](https://javadoc.io/doc/org.godotengine/godot/latest/index.html).
- **editor** module:
...
- To build the `editor` module:
  ...
  > ![image](img/android_studio_editor_configurations_drop_down.webp)
...
- To debug the `editor` module:
  ...
  > ![image](img/android_studio_editor_build_variant.webp)
  ...
  > ![image](img/android_studio_editor_debug_type_setup.webp)
...
- To build the `app` module:
  ...
  > ![image](img/android_studio_app_configurations_drop_down.webp)
...
- To debug the `app` module:
  ...
  > ![image](img/android_studio_app_build_variant.webp)
  > - Open the **Run/Debug Configurations** window by clicking on **Run > Edit Configurations...** on the top menu.
  ...
  > ![image](img/android_studio_app_debug_type_setup.webp)

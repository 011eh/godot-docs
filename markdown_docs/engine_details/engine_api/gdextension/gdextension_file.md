...
how to get started with C++ (godot-cpp), take a look at the [GDExtension C++ Example](../../../tutorials/scripting/cpp/gdextension_cpp_example.md#doc-godot-cpp-getting-started).
...
| **android_aar_plugin**    | Boolean | The GDExtension is part of a [v2 Android plugin](../../../tutorials/platform/android/android_plugin.md#doc-android-plugin). During export this flag<br/>will indicate to the editor that the GDExtension native shared libraries are exported by the Android<br/>plugin AAR binaries. |
...
Here are lists of some of the available built-in options (for more look at the [feature tags](../../../tutorials/export/feature_tags.md#doc-feature-tags)):
...
the stock editor icons. Read the guide for [creating icons](../../editor/creating_icons.md#doc-editor-icons)

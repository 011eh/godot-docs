...
A Vendor Runtime Module is a [Godot module](custom_modules_in_cpp.md#doc-custom-modules-in-cpp)
which is only applicable at runtime in a running project.
It is created like a regular [custom C++ module](custom_modules_in_cpp.md#doc-custom-modules-in-cpp), but is
packaged using an [editor plugin](../../tutorials/plugins/editor/making_plugins.md#doc-making-plugins) to make the functionality
...
Make sure to follow the [instructions for creating a custom C++ module](custom_modules_in_cpp.md#doc-creating-custom-modules-in-cpp).
...
See the [Compiling](../development/compiling/index.md#toc-devel-compiling) pages for more information.
...
Follow [these instructions](../../tutorials/plugins/editor/making_plugins.md#doc-making-plugins-template) to start creating the plugin. Your base plugin script should look like the following:
...
The next step is to define and instantiate an [EditorExportPlugin](../../classes/class_editorexportplugin.md#class-editorexportplugin) instance.
The [EditorExportPlugin](../../classes/class_editorexportplugin.md#class-editorexportplugin) instance is used to hook into the export flow and
